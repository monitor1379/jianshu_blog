...
最近在学习Keras，要使用到LeCun大神的MNIST手写数字数据集，直接从[官网](http://yann.lecun.com/exdb/mnist/)上下载了4个压缩包：

![MNIST数据集](http://upload-images.jianshu.io/upload_images/1624726-4906055f7086068b.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
根据以上解析规则，我使用了Python里的struct模块对文件进行读写（如果不熟悉struct模块的可以看我的另一篇博客文章[《Python中对字节流/二进制流的操作:struct模块简易使用教程》](http://www.jianshu.com/p/5a985f29fa81)）。IDX文件的解析通用接口如下：
```python
